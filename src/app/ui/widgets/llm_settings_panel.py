...
class LLMSettingsPanel(QWidget):
    ...
    def set_settings(self, settings: LLMOperationSettings) -> None:
        ...
        if custom_mode:
            ...
            if settings.context_window:
                self.custom_context_spin.setValue(int(settings.context_window))
        elif model_index != -1:
    ...
    def _build_ui(self) -> None:
        ...
        self.custom_context_spin.setRange(10_000, 4_000_000)
        self.custom_context_spin.setSingleStep(1_000)
        self.custom_context_spin.setValue(200_000)
        ...
        self.custom_model_edit.textChanged.connect(self.settings_changed)
        self.custom_context_spin.valueChanged.connect(self.settings_changed)
